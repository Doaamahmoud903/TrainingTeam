...
function CourseCardUpcoming({ data }) {
	return (
		<div className="card rounded bg-black bg-opacity-50 text-light overflow-hidden">
				...
				<div className="col-12 col-lg-8 d-flex align-items-center p-3">
					<div className=" w-100">
						...
						<div className=" d-flex flex-column flex-lg-row justify-content-between align-items-lg-center mt-3 flex-wrap">
							<div>
								<h6 className="">
									<i class="fa-regular fa-calendar me-2 text_primary"></i>
									{format(new Date('07-06-2023'), 'EEEE, LLLL do')}
								</h6>
								<h6 className="">
									<i class="fa-regular fa-rectangle-list me-2 text_primary"></i>
									12 lessons
								</h6>
							</div>

							<div className="d-flex justify-content-between">
								<h5 className=" d-block d-lg-none">LEV. 1</h5>
