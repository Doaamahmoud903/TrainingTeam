    ...
    return(
      ...
      <div className=" col-9">
        <div className="mt-3">
          ...
          <UsersInfo status={'In Active'} role={'Admin'} userId={'1200'} username={'Doaa'}/>
          <UsersInfo status={'In Active'} role={'Admin'} userId={'1200'} username={'Esraa'}/>
          <UsersInfo status={'In Active'} role={'Instractor'} userId={'1200'} username={'Mostafa'}/>
          <UsersInfo status={'In Active'} role={'Instractor'} userId={'1200'} username={'Yossef'}/>
        </div>
      </div>
      </div>
      </div>
